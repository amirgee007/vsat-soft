...
@section('pageTitle', 'ADD GENERAL DOCUMENTS')
@section('content')
    <!--main content start-->
    <section id="main-content">
        <section class="wrapper">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-header"><i class="fa fa-plus-square"></i>Add New General Document</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="{{ route('index.dashboard') }}">Home</a></li>
                        <li><i class="fa fa-file"></i><a href="{{ route('document.general.index') }}">General Documents</a></li>
                        <li><i class="fa fa-plus-square"></i>Add New General Document</li>
                    </ol>
                </div>
            </div>
            <!-- page start-->
