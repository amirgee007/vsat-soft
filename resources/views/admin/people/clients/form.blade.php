    ...
    <section class="panel">
        ...
        <div class="panel-content" style="clear: both;">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 col-xs-9">
                    <label class="col-sm-2 col-xs-3 control-label">Country {{@$client->country}}</label>
                    ...
                    <label class="col-sm-2 col-xs-3 control-label">City {{@$client->city}}</label>
                    <div class="col-sm-4 col-xs-3">
                    ...
                    <span class="col-sm-10 col-xs-9">
                        <input type="text" required name="street" class="form-control" value="{{@$client->street}}" placeholder="Street">
                    </span>

                    <label class="col-sm-2 control-label">Area</label>
                    <span class="col-sm-4">
                        <input required type="text" class="form-control" placeholder="Area" name="area" value="{{@$client->area}}">
                    </span>
                    <label class="col-sm-2 control-label">State</label>
                    <span class="col-sm-4">
                        <input required type="text" class="form-control" placeholder="State" name="state" value="{{@$client->state}}">
                    </span>
                    <label class="col-sm-2 control-label">Zip Code</label>
                    <span class="col-sm-4">
                        <input class="form-control field" name="zip_code" value="{{@$client->zip_code}}" placeholder="Zip Code" >
                    </span>

                    <label class="col-sm-2 control-label">P.O.Box</label>
                    <span class="col-sm-4">
                        <input type="text" class="form-control" placeholder="P.O.Box" name="po_box" value="{{ @$client->po_box }}">
                    </span>
                    ...
                    <span class="col-sm-4">
                        <input type="tel" class="form-control" placeholder="Fax No" name="fax_no" value="{{ @$client->fax_no }}">
                    </span>
                    ...
                    <span class="col-sm-4">
                        <input type="text" class="form-control" placeholder="Website" name="website" value="{{ @$client->website }}">
                    </span>
